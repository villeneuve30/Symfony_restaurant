...
class UserController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $this->addFlash('success', 'Utilisateur '.$user->getFirstname().' '.$user->getLastname().' créée !');
    ...
    public function edit(Request $request, User $user): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $this->addFlash('success', 'Utilisateur '.$user->getFirstname().' '.$user->getLastname().' mis à jour !');
    ...
    public function delete(Request $request, User $user): Response
    {
        if ($this->isCsrfTokenValid('delete'.$user->getId(), $request->request->get('_token'))) {
            $this->addFlash('success', 'Utilisateur '.$user->getFirstname().' '.$user->getLastname().' supprimé !');
            $entityManager = $this->getDoctrine()->getManager();
